...
color = isBlack; 
  ...
  public void mouseClicked(MouseEvent e) {	if (color) isBlackHuman=true; 
											else isBlackHuman=false; 
											noclick=false;}
  public void mouseExited(MouseEvent e) {}
  public void mouseEntered(MouseEvent e) {} public void mouseReleased(MouseEvent e) {}
...
if (isBlackTurn==isBlackHuman) human.play(logicalBoard, 0); 	
else bot.play(logicalBoard,4); 		
}
...
int i=0; 
while (game.canPlay() && game.playedSquares()<64 && game.getBlacks()!=0 && game.getWhites() !=0) {
//System.out.println(" This is turn  " + i); 
						...
						i++;
						 ...
						 if (blacks>whites) System.out.print("Black wins.");
						 else if (whites>blacks) System.out.print("White wins."); 
